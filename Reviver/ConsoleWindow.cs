...
namespace Reviver
{
	...
	// Position console view.
    	public static class PositionConsoleWindow
    	{
			...
			public static void PlaceConsoleView()
			{
				...
				wp.NormalPosition = new RECT() {
					Left = 600,// -fudgeOffset,
					Top = 400,//mi.rcWork.Bottom - (wp.NormalPosition.Bottom - wp.NormalPosition.Top),
					Right = 1024,//(wp.NormalPosition.Right - wp.NormalPosition.Left),
					Bottom = 600//fudgeOffset + mi.rcWork.Bottom
				};
